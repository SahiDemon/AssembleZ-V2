        ...
        return (
            <Card className="w-[500px] border-white/10 bg-black/60 backdrop-blur-xl shadow-2xl fade-in-up">
                <CardHeader className="space-y-3 pb-8">
                    <CardTitle className="text-3xl text-center font-bold tracking-tight">Verify Email</CardTitle>
    ...
    return (
        <Card className="w-[500px] border-white/10 bg-black/60 backdrop-blur-xl shadow-2xl fade-in-up">
            <CardHeader className="space-y-3 pb-8">
                ...
                <CardTitle className="text-3xl text-center font-bold tracking-tight">Create Account</CardTitle>
                <CardDescription className="text-center text-base">
                        ...
                        <div className="grid gap-2">
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    placeholder="••••••••••••"
                                    disabled={isLoading}
                                    className="h-12 bg-white/5 border-white/10 focus:border-card-accent/50 focus:ring-card-accent/20 pr-12 w-100"
                                ...
                                <Button
                                    ...
                                    variant="ghost"
                                    size="sm"
                                    className="border-white/10 absolute right-0 top-0 h-full px-3 py-2 hover:bg-transparent text-muted-foreground hover:text-white"
